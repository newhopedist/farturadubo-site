        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="order-2 lg:order-1 hidden lg:block bg-white rounded-xl p-8 border border-fartura-green-600 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-fartura-green-500 hover:ring-2 hover:ring-fartura-green-500/20">
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-gradient-to-br from-fartura-green-500 to-fartura-green-700 rounded-full flex items-center justify-center text-white shadow-lg">
          ...
          <div className="order-1 lg:order-2 bg-white rounded-xl p-6 md:p-8 border border-fartura-green-600 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-fartura-green-500 hover:ring-2 hover:ring-fartura-green-500/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-fartura-green-600 to-fartura-green-700 hover:from-fartura-green-700 hover:to-fartura-green-800 disabled:from-gray-400 disabled:to-gray-500 text-white py-3 px-6 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                {isSubmitting ? 'Enviando...' : 'Enviar Mensagem'}
              </button>

              {submitMessage && (
                <div className="bg-white border border-fartura-green-600 text-fartura-green-700 px-4 py-3 rounded-lg shadow-sm">
                  {submitMessage}
                </div>
              )}
            </form>
