...
export default function Products() {
  ...
  return (
    <section id="products" className="py-8 md:py-20 bg-gray-50 scroll-mt-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 md:mb-16">
          <h2 className="text-xl sm:text-2xl md:text-4xl font-bold text-fartura-green-900 mb-2 md:mb-4">
            Nossos Produtos
          </h2>
        ...
        <div className="flex justify-center mb-6 md:mb-8">
          <Link
            href="/produtos"
            className="bg-fartura-green-600 hover:bg-fartura-green-700 text-white px-4 py-2 md:px-6 md:py-3 rounded-lg font-medium transition-colors inline-flex items-center text-xs md:text-base"
          >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
            {displayProducts.map((item) => (
              <div key={item.id} className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl hover:border-fartura-green-300 transition-all duration-300 group">
                <div className="h-28 sm:h-40 md:h-56 bg-white flex items-center justify-center p-2 md:p-4 relative">
                ...
                <div className="p-3 md:p-5 border-t border-gray-100">
                  <h3 className="text-xs sm:text-base md:text-lg font-bold text-fartura-green-800 mb-0.5 md:mb-1">{item.name} {item.peso.toUpperCase()}</h3>
                  <p className="text-gray-500 text-[10px] sm:text-xs md:text-sm mb-2 md:mb-4">Ureia Agrícola Premium</p>
                  
                  <div className="flex flex-col gap-2 md:gap-3">
                    <div className="flex justify-between items-end">
                      <div>
                        <p className="text-sm sm:text-lg md:text-xl font-bold text-fartura-green-600 uppercase">
                          PRÉ-VENDA
                        </p>
                      </div>
                    </div>
                    ...
                    <Link
                      ...
                      className="w-full bg-white border-2 border-fartura-green-600 text-fartura-green-600 hover:bg-fartura-green-600 hover:text-white py-1.5 md:py-2 rounded-lg text-[10px] sm:text-xs md:text-sm font-bold transition-all duration-200 flex items-center justify-center"
                    >
