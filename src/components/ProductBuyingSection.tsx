    ...
    <div className="mt-8 border-t border-gray-100 pt-6">
      <div className="bg-fartura-green-50 rounded-xl p-6 border border-fartura-green-100 text-center">
        ...
        <div className="space-y-3">
          {/* Botão Avise-me (Leva ao formulário de contato) */}
          <a
            href="#contact"
          ...
          {/* Botão Falar com Especialista (WhatsApp direto) */}
          <a
            href="https://wa.me/5585991289449?text=Olá, gostaria de tirar dúvidas sobre os fertilizantes FARTURADUBO."
            target="_blank"
