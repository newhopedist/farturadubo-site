...
export default function Benefits() {
  ...
  return (
    <section
      id="benefits"
      className="relative py-8 md:py-20 scroll-mt-24 bg-cover bg-center"
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative text-center mb-6 md:mb-16 bg-white/90 backdrop-blur-sm px-4 py-6 md:px-8 md:py-12 rounded-2xl shadow-xl border border-gray-100 max-w-4xl mx-auto">
          ...
          <div className="w-12 md:w-24 h-1 md:h-1.5 bg-fartura-green-600 mx-auto mb-4 md:mb-8 rounded-full"></div>
          <p className="text-xs sm:text-sm md:text-xl text-fartura-green-800 font-medium max-w-3xl mx-auto leading-relaxed">
