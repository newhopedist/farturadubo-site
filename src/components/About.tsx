...
export default function About() {
  return (
    <section id="about" className="py-8 md:py-20 bg-white scroll-mt-24 -mt-10 sm:mt-0 relative z-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-12 items-center">
          <div>
            <h2 className="text-xl sm:text-2xl md:text-4xl font-bold text-fartura-green-900 mb-2 md:mb-6">
              Quem Somos
            </h2>
            <div className="w-12 md:w-20 h-1 bg-fartura-green-600 mb-4 md:mb-8"></div>
            <p className="text-xs sm:text-sm md:text-lg text-gray-700 mb-4 md:mb-6 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-6 mb-4 md:mb-8">
              <div className="bg-white p-2 md:p-4 rounded-xl shadow-lg border border-fartura-green-200">
                <div className="text-sm md:text-lg font-bold text-fartura-green-600 mb-0.5">Logística</div>
                <div className="text-[10px] md:text-sm text-gray-600">Entregas em todo o Brasil</div>
              </div>
              <div className="bg-white p-2 md:p-4 rounded-xl shadow-lg border border-fartura-green-200">
                <div className="text-sm md:text-lg font-bold text-fartura-green-600 mb-0.5">Qualidade</div>
                <div className="text-[10px] md:text-sm text-gray-600">Produtos Certificados</div>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3 md:gap-6 mb-4 md:mb-8">
              <div className="bg-white p-2 md:p-4 rounded-xl shadow-lg border border-fartura-green-200">
                <div className="text-sm md:text-lg font-bold text-fartura-green-600 mb-0.5">Suporte</div>
                <div className="text-[10px] md:text-sm text-gray-600">Atendimento Especializado</div>
              </div>
              <div className="bg-white p-2 md:p-4 rounded-xl shadow-lg border border-fartura-green-200">
                <div className="text-sm md:text-lg font-bold text-fartura-green-600 mb-0.5">Parceria</div>
                <div className="text-[10px] md:text-sm text-gray-600">Compromisso com o Produtor</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative h-full flex flex-col justify-between">
            <div className="bg-white rounded-2xl p-2 shadow-xl border border-gray-100 transform hover:scale-[1.02] transition-transform duration-500 h-full">
              <div className="relative h-full w-full rounded-xl overflow-hidden min-h-[300px] sm:min-h-[350px] md:min-h-[500px]">
                <Image
