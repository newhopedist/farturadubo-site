...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative pt-16 sm:pt-28 md:pt-40 pb-4 md:pb-12 bg-cover min-h-[160px] sm:min-h-[250px] md:min-h-[520px]"
      style={{ backgroundImage: `url(${brand.heroSrc})`, backgroundPosition: 'center 60%' }}
    ...
    >
      ...
      {brand.heroLogoSrc && (
        <div className="absolute top-4 right-4 md:top-8 md:right-8 opacity-95 hidden md:block">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-full flex items-center justify-center sm:justify-start">
        ...
        <div className="grid grid-cols-2 items-center w-full gap-2 md:gap-8 pt-0 sm:pt-0 pb-1 -mt-8">
          <div className="text-left relative z-10">
            ...
            <p className="text-[10px] sm:text-sm md:text-lg text-fartura-green-800 mb-2 md:mb-8 leading-relaxed max-w-full font-medium sm:max-w-[90%]">
